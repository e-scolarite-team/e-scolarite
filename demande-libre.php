...
{    
    ...
    {
        echo <<<EOC
    <h3 class="titre ombre">Demande de module libre</h3>
    <div class="detail-contenu" >
    <p>
        Cette page est consacrée pour demander un module libre.
    </p>
    <p>
        Pour réaliser la demande commencer par choisir le module libre ensuite cliquer sur envoyer.  
    </p>
    </div><!-- .detail-contenu -->
...
EOC;
        ...
        echo <<<EOC
    <div class="detail-contenu" >
        <form action="demande-libre-t.php" method="post">
        <fieldset>
            <legend>Choisir le module libre</legend>
EOC;
            $i=0;
...
EOC;
    ...
    public function traiter_donnees()
    {
        ...
        if(isset($_GET['err']) and is_numeric($_GET['err']))
        {
            ...
            {
                case 104:
                    $this->msgr='Veuillez choisir le module.';
                    break;
                case 105:
        ...
        if(isset($_GET['i']) and is_numeric($_GET['i']))
        {
            ...
            {
                case 100:
                    $this->msgi='Votre demande a été envoyée avec succès.';
                    break;
                default:
                    $this->msgi='';
                    break;
