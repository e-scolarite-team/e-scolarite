...
{    
    ...
    public function traiter_donnees()
    {
        ...
        if(isset($_POST['r']))
        {
            ...
            $req = "INSERT INTO `reclamationchanger`(`cne`,`dateenvoi`)VALUES(?,NOW());";
            ...
            if($id and isset($_POST['a']))
            {
                ...
                {
                    redirectToPage("reclamation-changement.php?err=105");
                    exit();
                }
            }
            ...
            $stmt->close();
            db_engine::fermer();
            redirectToPage("reclamation-changement.php?i=100");
            exit();
        }
        else
        {
            redirectToPage("reclamation-changement.php?err=104");
            exit();
        }
        redirectToPage("reclamation-changement.php");
        exit();
    }
}
